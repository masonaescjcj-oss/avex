...
> اگر سیستم **از قبل راه افتاده** و دنبال وضعیت فعلی هستی — پورت‌ها، سرویس‌ها، کدام
> دیتابیس، هر رمز کجاست، چه کاری مانده — آن در [`docs/LIVE-STATE-fa.md`](docs/LIVE-STATE-fa.md)
> است. این فایل برای راه‌اندازی از صفر است.
